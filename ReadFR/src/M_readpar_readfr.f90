module M_readpar_readfr
  ...
  type(sentence), save :: ParSections(3)
  character(len=LEN_STR) :: NAMEKEY(3)
  data NAMEKEY /'PEDFILE:', 'MAPFILE:', 'FRFILE:'/ 
...
contains
  ...
  subroutine parse_section_info(sec, info, FR_QC, outinfo)
    type(sentence), intent(in) :: sec

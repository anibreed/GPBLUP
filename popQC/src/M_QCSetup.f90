module M_QCSetup
  use M_Kinds
  use M_Variables
  use M_readpar_popqc, only: read_parameters
  use M_Hashtable
  use H_PedRead
  use M_StrEdit
  implicit none
...
contains
  ...
  subroutine load_pedigree_info_mod(io_pht, out_n_animals, in_ped_key_field)
    ...
    print *, '  Loading PED into hashtable: ', trim(PEDFile%FileName)
